...
// // Mock data for chart
// const apiUsageData = [
//   { name: 'Mon', transfers: 65, balanceChecks: 45, invoices: 15 },
//   { name: 'Tue', transfers: 59, balanceChecks: 49, invoices: 12 },
//   { name: 'Wed', transfers: 80, balanceChecks: 90, invoices: 18 },
//   { name: 'Thu', transfers: 81, balanceChecks: 39, invoices: 25 },
//   { name: 'Fri', transfers: 56, balanceChecks: 75, invoices: 10 },
//   { name: 'Sat', transfers: 55, balanceChecks: 32, invoices: 9 },
//   { name: 'Sun', transfers: 40, balanceChecks: 19, invoices: 5 },
// ];
...
//             Welcome back, you've been active today.
//           </p>
//         </div>
//       </div>
...
//             </CardHeader>
//             <CardContent>
//               <div className="text-2xl font-bold">91,055</div>
//               <div className="flex items-center space-x-2 text-sm text-muted-foreground mt-1">
//                 <span>of 100,000 monthly requests</span>
//               </div>
//             </CardContent>
//           </Card>
//         </motion.div>
...
//               <CardDescription>
//                 Daily API requests by endpoint type
//               </CardDescription>
//             </CardHeader>
...
//                   <Bar dataKey="balanceChecks" name="Balance Checks" fill="#10b981" radius={[4, 4, 0, 0]} />
...
//             <CardDescription>
//               Your latest API activities and account updates
//             </CardDescription>
//           </CardHeader>
//           <CardContent>
...
//                   description: "Transferred $2,500.00 from Account A to Account B",
//                   time: "Just now"
//                 },
//                 {
//                   icon: <Bell className="h-5 w-5 text-amber-500" />,
//                   title: "Rate Limit Warning",
//                   description: "You're approaching 80% of your API rate limit",
//                   time: "2 hours ago"
//                 },
//                 {
//                   icon: <ArrowDownLeft className="h-5 w-5 text-blue-500" />,
//                   title: "Payment Received",
//                   description: "Received $1,250.00 from External Account",
//                   time: "Yesterday"
//                 },
//                 {
