...
//       case 'paid':
//         return (
//           <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800 dark:bg-green-800/20 dark:text-green-500">
...
//       case 'pending':
//         return (
//           <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-yellow-100 text-yellow-800 dark:bg-yellow-800/20 dark:text-yellow-500">
...
//       case 'generated':
//         return (
//           <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800 dark:bg-blue-800/20 dark:text-blue-500">
...
//       default:
//         return (
//           <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-gray-100 text-gray-800 dark:bg-gray-800/20 dark:text-gray-500">
//             {status}
//           </span>
//         );
//     }
...
//                 <Card>
//                   <CardHeader>
//                     <CardTitle>Generate Period Invoice</CardTitle>
//                     <CardDescription>
...
//                   Invoices are stored for up to 7 years in accordance with financial regulations.
//                 </p>
//               </CardFooter>
//             </Card>
//           </TabsContent>
  ...
  const renderMobileInvoiceCard = (invoice:any) => (
    <Card key={invoice.id} className="mb-3">
      <CardContent className="pt-4">
        ...
        <div className="text-xs text-muted-foreground mb-2">{invoice.period}</div>
          ...
          <TabsContent value="generate">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
              <div className="lg:col-span-2">
                <Card>
                  <CardHeader>
                    <CardTitle className="text-lg sm:text-xl">Generate Period Invoice</CardTitle>
                ...
                {isMobile ? (
                  ...
                  <div className="rounded-md border overflow-hidden overflow-x-auto">
                    <table className="min-w-full divide-y divide-border">
                      <thead className="bg-muted/50">
                        <tr>
                          <th scope="col" className="px-4 sm:px-6 py-3 text-left text-xs font-medium text-muted-foreground uppercase tracking-wider">
                            Invoice ID
                          </th>
                          <th scope="col" className="px-4 sm:px-6 py-3 text-left text-xs font-medium text-muted-foreground uppercase tracking-wider">
                            Period
                          ...
                          <th scope="col" className="px-4 sm:px-6 py-3 text-right text-xs font-medium text-muted-foreground uppercase tracking-wider">
                            Actions
                          </th>
                        </tr>
                      </thead>
