...
//       // Would be replaced with actual API call or redirect to Stripe:
...
//             Choose the plan that fits your development needs, with no hidden fees or surprises.
//           </p>
...
//               onCheckedChange={(checked:any) => setBillingCycle(checked ? 'yearly' : 'monthly')}
//             />
...
//             <motion.div
//               key={plan.id}
//               className={`bg-card border rounded-xl overflow-hidden ${plan.popular ? 'shadow-lg border-blue-500' : 'shadow-sm'}`}
//               initial={{ opacity: 0, y: 20 }}
//               animate={{ opacity: 1, y: 0 }}
...
//                       {plan.price[billingCycle] > 0 ? `/ ${billingCycle === 'monthly' ? 'month' : 'month, billed yearly'}` : 'forever'}
//                     </span>
//                   </div>
//                 </div>
...
//                 <Button
//                   className={`w-full ${plan.popular ? 'bg-gradient-to-r from-blue-600 to-cyan-500 hover:from-blue-700 hover:to-cyan-600' : ''}`}
...
//                 answer: "If you exceed your plan's rate limits, requests will return a 429 error code. You can view your current usage in the dashboard. We'll notify you when you're approaching your limits."
//               },
//               {
//                 question: "Is there a free trial for paid plans?",
//                 answer: "Yes! All paid plans come with a 14-day free trial. You won't be charged until the trial period ends. No credit card is required to start a trial."
//               },
//               {
//                 question: "How do I cancel my subscription?",
//                 answer: "You can cancel anytime from your account settings. Cancellations take effect at the end of your current billing period. You'll retain access to paid features until then."
//               },
//               {
//                 question: "What payment methods do you accept?",
//                 answer: "We accept all major credit cards (Visa, Mastercard, American Express) as well as PayPal. Enterprise customers can request invoice billing."
//               }
//             ].map((faq, index) => (
//               <motion.div
//                 key={index}
