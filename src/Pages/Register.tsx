        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-24 items-center">
          ...
          >
            <div className="bg-blue-50 dark:bg-blue-950/30 rounded-2xl p-8">
              <h2 className="text-2xl font-semibold mb-6">Why Join FinConnect?</h2>
              ...
              <ul className="space-y-4">
                {[
                  ...
                  },
                  {
                    ...
                    description: "Choose from multiple tiers to match your application's needs and scale as you grow."
                  },
                  {
                    title: "Developer-First Experience",
                    description: "Clean documentation, robust SDKs, and responsive support to help you build faster."
                  },
                  {
                    title: "Sandbox Environment",
                    description: "Test and iterate with our fully-featured sandbox before going to production."
                  }
                ].map((item, index) => (
                  <motion.li 
                    key={index}
              ...
              <div className="mt-8">
                <blockquote className="italic text-muted-foreground border-l-4 border-blue-500 pl-4">
                  "FinConnect has revolutionized how we handle financial data integration. Our development time was cut in half."
